    ...
    <section className="panel overflow-hidden">
      <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3">
        <div>
          ...
          <h2 className="text-base font-semibold text-white">Performance by Security</h2>
        </div>
          ...
          <tbody>
            {rows.map((row) => (
              <tr key={row.ticker} className="border-t border-[var(--border)] text-zinc-200">
                <td className="px-4 py-2 font-semibold text-white">{row.ticker}</td>
                <td className="px-4 py-2">{row.name}</td>
                <td className="px-4 py-2">{row.sector}</td>
                <td className="px-4 py-2">{row.day1}</td>
                <td className="px-4 py-2">{row.day5}</td>
                <td className="px-4 py-2">{row.month1}</td>
                <td className="px-4 py-2">{row.month3}</td>
                <td className="px-4 py-2">{row.month6}</td>
                <td className="px-4 py-2">{row.year1}</td>
